...
CREATE TABLE IF NOT EXISTS forensic_financials (
    ...
    roce                      NUMERIC,
    roce_5y_avg               NUMERIC,
    roce_wacc_spread          NUMERIC,
    roic_5y_avg               NUMERIC,
    roiic_5y                  NUMERIC,
    wacc                      NUMERIC,

    gross_debt_to_ebitda      NUMERIC,
    net_debt_to_ebitda        NUMERIC,
    interest_coverage         NUMERIC,
    dscr                      NUMERIC,

    beneish_m_score           NUMERIC,
    altman_z_double_prime     NUMERIC,
    piotroski_f_score         INT,
    sloan_accrual             NUMERIC,

    cfo_to_ebitda_5y          NUMERIC,
    cfo_to_pat                NUMERIC,
    fcf_years_positive        INT,
    gross_margin_stable       BOOLEAN DEFAULT TRUE,
    ...
    implied_dcf_growth        NUMERIC,
    implied_dcf_growth_bear   NUMERIC,
    implied_dcf_growth_base   NUMERIC,
    implied_dcf_growth_bull   NUMERIC,
    fcf_yield                 NUMERIC,
    has_rpt_siphoning         BOOLEAN DEFAULT FALSE,
    esop_dilution_annual      NUMERIC,
